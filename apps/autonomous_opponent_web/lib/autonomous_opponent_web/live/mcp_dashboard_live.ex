defmodule AutonomousOpponentWeb.MCPDashboardLive do
  @moduledoc """
  LiveView dashboard for monitoring MCP Gateway metrics in real-time.
  ...
  def render(assigns) do
    ...
    <div class="mcp-dashboard">
      <h1 class="text-3xl font-bold mb-6">MCP Gateway Dashboard</h1>
