defmodule AutonomousOpponentV2Web.WebGatewayChannel do
  @moduledoc """
  Phoenix Channel for WebSocket transport in Web Gateway.
  ...
  @doc """
  Handles client joining the Web Gateway channel.
  """
  def join("web_gateway:gateway", params, socket) do
