defmodule AutonomousOpponentV2Core.WebGateway.Pool.ConnectionPool do
  @moduledoc """
  Connection pooling for Web Gateway transports using poolboy.
  ...
  def init(opts) do
    ...
    children = [
      ...
      {Task.Supervisor, name: AutonomousOpponentV2Core.WebGateway.Pool.TaskSupervisor},
      {__MODULE__.Monitor, []}
    ]
  ...
  defmodule Monitor do
    ...
    def handle_info(:health_check, state) do
      ...
      health_status = AutonomousOpponentV2Core.WebGateway.Pool.ConnectionPool.health_check()
      
      # Report metrics
      stats = AutonomousOpponentV2Core.WebGateway.Pool.ConnectionPool.get_stats()
