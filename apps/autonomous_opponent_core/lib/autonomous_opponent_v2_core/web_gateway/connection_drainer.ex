defmodule AutonomousOpponentV2Core.WebGateway.ConnectionDrainer do
  @moduledoc """
  Handles graceful shutdown of Web Gateway connections during deployments.
  ...
  defp stop_accepting_connections do
    ...
    Registry.update_value(
      AutonomousOpponentV2Core.WebGateway.ConfigRegistry,
      :accepting_connections,
      fn _ -> false end
    )
