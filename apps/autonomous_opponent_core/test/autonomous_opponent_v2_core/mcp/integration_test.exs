defmodule AutonomousOpponentV2Core.MCP.IntegrationTest do
  @moduledoc """
  Integration tests for the complete MCP Gateway system including
  VSM integration, load testing, and end-to-end scenarios.
  """
  
  use ExUnit.Case
  
  alias AutonomousOpponentV2Core.MCP.{Gateway, Transport.Router}
  ...
  describe "end-to-end message flow" do
    test "message flows from client through gateway to VSM" do
      ...
      # Should receive in MCP message handler
      assert_receive {:event_bus, :mcp_message_received, event}
  ...
  describe "concurrent connection handling" do
    ...
    test "handles high message throughput" do
      ...
      received = for _ <- 1..message_count do
        assert_receive {:event_bus, :mcp_message_received, _}, 1000
        1
      end
  ...
  describe "VSM integration" do
    ...
    test "variety flow through VSM channels" do
      ...
      assert_receive {:event_bus, :mcp_message_received, _}
