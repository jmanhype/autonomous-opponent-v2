defmodule AutonomousOpponentV2Core.MCP.Transport.RouterTest do
  @moduledoc """
  Tests for the MCP transport router with intelligent routing and failover.
  """
  
  use ExUnit.Case, async: true
  
  alias AutonomousOpponentV2Core.MCP.Transport.Router
