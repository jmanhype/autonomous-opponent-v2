defmodule AutonomousOpponentV2Core.WebGateway.ConnectionDrainerTest do
  use ExUnit.Case, async: true
  
  alias AutonomousOpponentV2Core.WebGateway.ConnectionDrainer
  ...
  describe "start_draining/1" do
    ...
    test "executes callback on completion", %{drainer: _} do
      ...
      Registry.unregister(AutonomousOpponentV2Core.WebGateway.TransportRegistry, {:transport, :websocket})
      Registry.unregister(AutonomousOpponentV2Core.WebGateway.TransportRegistry, {:transport, :http_sse})
    ...
    test "times out with remaining connections" do
      ...
      Registry.register(AutonomousOpponentV2Core.WebGateway.TransportRegistry, {:transport, :websocket}, nil)
