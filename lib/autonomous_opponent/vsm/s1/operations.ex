defmodule AutonomousOpponent.VSM.S1.Operations do
  ...
  # Spawn new units when absorption < 70%
  @spawn_threshold 0.7
  # 1 minute variety measurement window
  @measurement_window 60_000
  ...
  defp absorb_into_buffer(event, state) do
    ...
    new_buffer =
      if :queue.len(new_buffer) > 1000 do
  ...
  defp measure_and_update_absorption(state) do
    ...
    %{state | absorption_rate: absorption_rate, last_measurement: current_time}
  end
