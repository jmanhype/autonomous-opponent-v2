defmodule AutonomousOpponent.VSM.Algedonic.System do
  ...
  @response_time_target 100  # 100ms max response time
  @signal_ttl 300_000       # 5 minutes signal memory
  @filter_threshold 3       # Minimum occurrences to pass filter
  ...
  defp calculate_priority(signal) do
    base_priority = case signal[:severity] || signal[:intensity] do
      :critical -> 1000
      :high -> 100
      :medium -> 10
      :low -> 1
