defmodule AutonomousOpponent.VSM.S3.AuditSubsystem do
  ...
  # 30 seconds between audits
  @audit_interval 30_000
  @intervention_threshold %{
    # Below 70% triggers intervention
    allocation_efficiency: 0.7,
    # 50% over target
    response_time_violation: 1.5,
    # Below 80% stability
    stability_index: 0.8,
    # 5 failed rounds
    bargaining_deadlock: 5
  }
  ...
  defp check_compliance(metrics) do
    %{
      allocation_efficiency:
        metrics.allocation_efficiency >= @intervention_threshold.allocation_efficiency,
      response_time:
        metrics.average_response_time <= 100 * @intervention_threshold.response_time_violation,
